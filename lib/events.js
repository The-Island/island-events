...
Events.prototype.inflate = function(e, query, cb) {
  ...
  function __session(o, p, cb) {
    Step(
      ...
      function (err) {
        if (err) return this(err);
        _.each(o[p].actions, _.bind(function (a) {
          self.db.fill(a.ticks, 'Medias', 'parent_id', {sort: {created: -1}},
              this.parallel());
          self.db.fill(a.ticks, 'Comments', 'parent_id', {sort: {created: -1},
              limit: 5, reverse: true, inflate: {author: profiles.member}},
              this.parallel());
          self.db.fill(a.ticks, 'Hangtens', 'parent_id', this.parallel());
        }, this));
      },
      function () {
  ...
  function __tick(o, p, cb) {
    Step(
      function () {
        self.db.inflate(o[p], {author: profiles.member, ascent: profiles.ascent,
